...
-->
    ...
    <link rel="stylesheet" href="{{asset('admin/assets/css/templatemo-klassy-cafe.css')}}">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{asset('admin/assets/images/klassy-logo.png')}}" align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                ...
                <!-- <div class="col-lg-8">
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                            ...
                            <!-- <div class="item">
                                <div class="img-fill">
                                    <img src="{{asset('admin/assets/images/slide-01.jpg')}}" alt="">
                                </div>
                            </div> -->
                            <!-- // Item -->
                            <!-- Item -->
                            <!-- <div class="item">
                                <div class="img-fill">
                                    <img src="{{asset('admin/assets/images/slide-02.jpg')}}" alt="">
                                </div>
                            </div> -->
                            <!-- // Item -->
                            <!-- Item -->
                            <!-- <div class="item">
                                <div class="img-fill">
                                    <img src="{{asset('admin/assets/images/slide-03.jpg')}}" alt="">
                                </div>
                            </div> -->
                            <!-- // Item -->
                        <!-- </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <img src="{{asset('admin/assets/images/about-thumb-01.jpg')}}" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{asset('admin/assets/images/about-thumb-02.jpg')}}" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{asset('admin/assets/images/about-thumb-03.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            ...
                            <img src="{{asset('admin/assets/images/about-video-bg.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="{{asset('admin/assets/images/chefs-01.jpg')}}" alt="Chef #1">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="{{asset('admin/assets/images/chefs-02.jpg')}}" alt="Chef #2">
                        </div>
                        <div class="down-content">
                            <h4>David Martin</h4>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="{{asset('admin/assets/images/chefs-03.jpg')}}" alt="Chef #3">
                        </div>
                        <div class="down-content">
                            <h4>Peter Perkson</h4>
    ...
    <!-- Global Init -->
    <script src="{{asset('admin/admin/assets/js/custom.js')}}"></script>
    <script>
        $(function() {
            var selectedClass = "";
            $("p").click(function() {
